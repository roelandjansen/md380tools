...
void create_menu_entry_rbeep_enable_screen(void) {
  ...
  create_menu_entry_hook( (*md380_menu_id), wt_enable, md380_menu_entry_back, md380_menu_entry_back, 6, 2 , 1);
...
void create_menu_entry_rbeep_disable_screen(void) {
  ...
  create_menu_entry_hook( (*md380_menu_id), wt_disable, md380_menu_entry_back, md380_menu_entry_back, 6, 2 , 1);
...
void create_menu_entry_datef_original_screen(void) {
  ...
  create_menu_entry_hook( (*md380_menu_id), wt_datef_original, md380_menu_entry_back, md380_menu_entry_back, 6, 2 , 1);
...
void create_menu_entry_datef_germany_screen(void) {
  ...
  create_menu_entry_hook( (*md380_menu_id), wt_datef_germany, md380_menu_entry_back, md380_menu_entry_back, 6, 2 , 1);
...
void create_menu_entry_rbeep_screen(void) {
  ...
  create_menu_entry_hook( (*md380_menu_id),     wt_enable,  create_menu_entry_rbeep_enable_screen + 1,  md380_menu_entry_back, 0x8b, 0 , 1);
  create_menu_entry_hook( (*md380_menu_id) + 1, wt_disable, create_menu_entry_rbeep_disable_screen + 1, md380_menu_entry_back, 0x8b, 0 , 1);
...
void create_menu_entry_datef_screen(void) {
  ...
  create_menu_entry_hook( (*md380_menu_id),     wt_datef_original,  create_menu_entry_datef_original_screen + 1, md380_menu_entry_back,  0x8b, 0 , 1);
  create_menu_entry_hook( (*md380_menu_id) + 1, wt_datef_germany,  create_menu_entry_datef_germany_screen + 1, md380_menu_entry_back, 0x8b, 0 , 1);
...
void create_menu_entry_userscsv_screen(void) {
  ...
  create_menu_entry_hook( (*md380_menu_id),     wt_enable,  create_menu_entry_userscsv_enable_screen + 1, md380_menu_entry_back,  0x8b, 0 , 1);
  create_menu_entry_hook( (*md380_menu_id) + 1, wt_disable, create_menu_entry_userscsv_disable_screen + 1, md380_menu_entry_back, 0x8b, 0 , 1);
...
void create_menu_entry_debug_screen(void) {
  ...
  create_menu_entry_hook( (*md380_menu_id),     wt_enable,  create_menu_entry_debug_enable_screen + 1, md380_menu_entry_back,  0x8b, 0 , 1);
  create_menu_entry_hook( (*md380_menu_id) + 1, wt_disable, create_menu_entry_debug_disable_screen + 1, md380_menu_entry_back, 0x8b, 0 , 1);
...
void m(void) {
  ...
  *md380_menu_depth = *md380_menu_depth - 1;
  create_menu_entry_hook( (*md380_menu_id), md380_menu_edit_buf,    md380_menu_entry_back,  md380_menu_entry_back  ,6, 1 , 1);
...
void create_menu_entry_addl_functions_screen(void) {
  ...
  create_menu_entry_hook( (*md380_menu_id),     wt_rbeep,    create_menu_entry_rbeep_screen + 1,    md380_menu_entry_back, 0x98, 0 , 1);
  create_menu_entry_hook( (*md380_menu_id) + 1, wt_datef,    create_menu_entry_datef_screen + 1,    md380_menu_entry_back, 0x98, 0 , 1);
  create_menu_entry_hook( (*md380_menu_id) + 2, wt_userscsv, create_menu_entry_userscsv_screen + 1, md380_menu_entry_back, 0x98, 0 , 1);
  create_menu_entry_hook( (*md380_menu_id) + 3, wt_debug,    create_menu_entry_debug_screen + 1,    md380_menu_entry_back, 0x98, 0 , 1);
  create_menu_entry_hook( (*md380_menu_id) + 4, wt_edit,     create_menu_entry_edit_screen +1 ,     md380_menu_entry_back, 0x8a, 0 , 1);
...
#endif
  create_menu_entry_hook(8, md380_wt_programradio, md380_menu_entry_programradio , md380_menu_entry_back, 0x8a, 0 , enabled);
  create_menu_entry_hook(9, wt_addl_func,     create_menu_entry_addl_functions_screen + 1 , md380_menu_entry_back, 0x8a,0 , 1);
}
